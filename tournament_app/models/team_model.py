...
class teamModel(models.Model):
    ...
    logo = fields.Binary(string='Photo',help='team\'s logo')
    ...
    tornaments_ids = fields.Many2many("tournament_app.tournament_model",relation="teams2tournaments_rel",string="Tournaments",help="Tournaments played")
